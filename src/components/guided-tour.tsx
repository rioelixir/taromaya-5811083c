...
export const DEFAULT_TOUR: TourStep[] = [
  ...
  { title: "4. AI Reading", body: "Every module includes a professional AI interpretation in your chosen language, written from your own chart rather than generic text." },
