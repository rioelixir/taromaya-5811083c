    ...
    <div className="relative min-h-dvh grid place-items-center px-4 py-16 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass rounded-3xl p-8">
          ...
          <button
            onClick={onGoogle}
            className="mt-6 w-full rounded-xl border border-white/15 bg-white/5 px-4 py-3 text-sm text-pearl hover:bg-white/10 flex items-center justify-center gap-3"
          >
          ...
          <form onSubmit={onEmail} className="space-y-3">
            ...
            <button
              disabled={loading}
              className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-gold to-gold-soft text-cosmic font-medium py-3 disabled:opacity-40"
            >
